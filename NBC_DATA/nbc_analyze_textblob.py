...
analyze('nbc_trump_url.txt','nbc_trump_analyze_textblob.txt')
analyze('nbc_hillary_url.txt','nbc_hillary_analyze_textblob.txt')

# import threading
# thread1=threading.Thread(target=analyze,args=('nbc_trump_url.txt','cnn_trump_analyze.txt',))
# thread2=threading.Thread(target=analyze,args=('nbc_hillary_url.txt','cnn_hillary_analyze.txt',))
# try:
#     thread1.start()
#     thread2.start()
# except:
