...
analyze('washingtonpost_trump_url.txt','washingtonpost_trump_analyze_textblob.txt')
# analyze('washingtonpost_hillary_url.txt','washingtonpost_hillary_analyze_textblob.txt')


# import threading
# thread1=threading.Thread(target=analyze,args=('washingtonpost_trump_url.txt','washingtonpost_trump_analyze_textblob.txt',))
# thread2=threading.Thread(target=analyze,args=('washingtonpost_hillary_url.txt','washingtonpost_hillary_analyze_textblob.txt',))
# try:
#     thread1.start()
#     thread2.start()
# except:
