...
import threading
thread1=threading.Thread(target=analyze,args=('cnn_trump_url.txt','cnn_trump_analyze_textblob.txt',))
thread2=threading.Thread(target=analyze,args=('cnn_hillary_url.txt','cnn_hillary_analyze_textblob.txt',))
try:
    thread1.start()
    thread2.start()
except:
